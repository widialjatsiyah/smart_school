                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/walkingm/pay" method="post">
                                    <table class="table2" width="100%">
                                       ...
                                       <?php
                                        ...
                                        ?>
                                    <tr class="bordertoplightgray">
                                        <td colspan="2" class="text-right"><?php echo $this->lang->line('total');?>: <?php echo $this->customlib->getSchoolCurrencyFormat() . amountFormat($amount)+$this->customlib->getGatewayProcessingFees($amount+$this->customlib->getGatewayProcessingFees($amount)); ?></td>
                                    </tr>
                                   <tr class="border_bottom">
                                            <td> 
