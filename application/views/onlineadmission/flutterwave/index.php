                        ...
                        <div class="paymentbg">
                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/flutterwave/pay" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <td colspan="2" class="text-right"><?php echo $this->lang->line('processing_fees');?>: <?php echo $this->customlib->getSchoolCurrencyFormat() . amountFormat($this->customlib->getGatewayProcessingFees($amount)+$this->customlib->getGatewayProcessingFees($amount)); ?></td>
                                    </tr>
                                            <?php
                                        }
                                        ?>
